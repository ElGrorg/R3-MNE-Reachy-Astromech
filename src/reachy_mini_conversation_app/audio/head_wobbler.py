...
class HeadWobbler:
    ...
    def feed_raw(self, audio_chunk: NDArray[np.int16]) -> None:
        """Thread-safe: push raw audio numpy array into the consumer queue."""
        with self._state_lock:
            generation = self._generation
        self.audio_queue.put((generation, SAMPLE_RATE, audio_chunk))
